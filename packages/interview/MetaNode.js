...
MetaNode.define({
  type: 'meta',
  short_summary: { type: 'string', default: '', field: { editor: "multitext", description: "short-summary-description", group: 'short-summary'}},
  description: { type: 'string', default: '', field: { editor: "multitext", description: "comment-description", group: 'short-summary'}},
  abstract: { type: 'string', default: '', field: { editor: "multitext", description: "abstract-description", group: 'abstract'}},
  ...
  interviewee_place_of_death: { type: 'string', default: '', field: { editor: "text", description: "place-of-death-description", group: 'person-details'}},
  interviewee_date_of_death: { type: 'string', default: '', field: { editor: "input", dataType: "date", description: "date-of-death-description", group: 'person-details'}},
